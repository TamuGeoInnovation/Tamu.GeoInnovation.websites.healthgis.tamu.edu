<%@ Page Language="C#" MasterPageFile="~/Master_Section_Services.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Services_Default" Title="Third International ACM SIGSPATIAL Workshop on HealthGIS (HealthGIS'14) - Objectives" %>

<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolderHead" Runat="Server">
    <meta name="description" content="Third International ACM SIGSPATIAL Workshop on HealthGIS (HealthGIS'14) Objectives"/>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentAreaHeader" Runat="Server">    
    Third International ACM SIGSPATIAL Workshop on HealthGIS (HealthGIS'14)  - Objectives
</asp:Content>    
